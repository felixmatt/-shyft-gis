...
class catchment_layers:
    ...
    def _calculate_means(self, polygon_layer_files, raster_layer_files, attribute_names):
    ...
    def calculate_landcover_attributes(self):
        self._calculate_means(self.polygon_layer_files, self.raster_layer_files, self.fraction_attribute_names)
    
    def  calculate_topography_attributes(self):
        self._calculate_means(self.polygon_layer_files, self.dem_feature_files, self.dem_feature_attribute_names)
...
def create_cell_data_files(catchment, outfile):
    """
